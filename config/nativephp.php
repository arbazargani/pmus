...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.nativepushe.app'),
     ...
     * nativephp://some/path
     */
    'deeplink_scheme' => env('nativepushe://'),

    /**
     * The author of your application.
     */
    'author' => env('Primer Studio'),

    /**
     * The copyright notice for your application.
     */
    'copyright' => env('Primer Studio'),

    /**
     * The description of your application.
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Pushe native port'),

    /**
     * The Website of your application.
     */
    'website' => env('NATIVEPHP_APP_WEBSITE', 'https://primerstudio.io'),
    ...
    'updater' => [
        ...
        'providers' => [
            'github' => [
                'driver' => 'github',
                'repo' => env('GITHUB_REPO', 'pmus'),
                'owner' => env('GITHUB_OWNER', 'arbazargani'),
                'token' => env('GITHUB_TOKEN', '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'),
